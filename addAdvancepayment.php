    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="Controler/advancepaymentControler.php?action=add" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10 offset-2">
                                <button type="submit" name="payad" class="btn btn-primary">Pay</button>
